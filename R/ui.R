...
shiny::tags$p(
                ...
                " from hCD34+ MISTRG humanized mice, in which a human immune system develops",
              ...
              shiny::tags$p(
                ...
                " - the analyses that identify ", shiny::tags$strong("MAFB"),
                " as a key transcriptional driver of tumor-associated macrophage identity",
                " (the default TF in the Network tab)."
              ),
              shiny::tags$p(
