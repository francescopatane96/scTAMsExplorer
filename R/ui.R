...
shiny::tags$p(
                ...
                shiny::tags$a(
                  href   = "https://u-cri.ulb.be/index.php?action=researchGroups&group=1",
                  target = "_blank",
                  rel    = "noopener noreferrer",
                  shiny::tags$strong("Stanislas Goriely Laboratory")
                ),
                " from fetal hCD34+ MISTRG humanized mice, in which a human immune system develops",
                " from engrafted hematopoietic stem cells, allowing human",
                " monocyte-to-macrophage differentiation to be studied directly inside living",
                " tissue. It comprises single-cell transcriptomic profiles of monocytes and",
                " macrophages collected across multiple organs and tissue compartments,",
                " spanning both healthy sites and tumors (cell line-derived xenografts),",
                " to capture how macrophage states are shaped by their microenvironment.",
                " Cells were sequenced using 10x Genomics Chromium technology, aligned with",
                " Cell Ranger, and processed in Seurat with Harmony-based batch correction",
                " for cross-sample integration."
              ),
             shiny::tags$p(
                ...
                " Co-expression modules, Gene Regulatory Networks (GRNs) and TF activity inferred with ",
                shiny::tags$a(
                  href   = "https://github.com/smorabit/hdWGCNA",
                  target = "_blank",
                  rel    = "noopener noreferrer",
                  "hdWGCNA"
                ),
              ...
              shiny::tags$p(
                style = "font-size:13px;color:#6b7f96;",
                "This atlas accompanies the preprint ",
                shiny::tags$em(
                  "Regulatory Networks Shaping Human Tumor-Associated Macrophages In Vivo ",
                  "Identify MAFB as a Key Transcriptional Driver"
                ),
                " (Detavernier A., Donckier de Donceel E., Patanè F., et al., Research Square, 2026; ",
                shiny::tags$a(
                  href   = "https://doi.org/10.21203/rs.3.rs-8562817/v1",
                  target = "_blank",
                  "doi:10.21203/rs.3.rs-8562817/v1"
                ),
            ...
            shiny::tags$div(class = "feature-grid",
              .feature_card(shiny::HTML("&#128506;"), "UMAP + Expression + Markers", list(
                "UMAP coloured by any metadata column (e.g. Module activity scores. Mod-1/5)",
              ...
              .feature_card(shiny::HTML("&#127760;"), "Gene Regulatory Networks", list(
            ...
            shiny::tags$div(class = "info-footer",
              shiny::tags$div(class = "footer-credit",
                shiny::tags$strong("Stanislas Goriely Lab"), shiny::tags$br(),
                "Institute of Medical Immunology (IMI) - Université Libre de Bruxelles (ULB)",
                shiny::tags$br(),
                shiny::tags$span(style = "font-size:12px;color:#6b7f96;",
                  "Dataset and analysis pipeline developed by Stanislas Goriely Laboratory.")
              ),
              shiny::tags$span(class = "footer-badge", "Stanislas Goriely Lab - ULB")
            ),
            ...
            shiny::mainPanel(width = 9,
              shiny::tags$div(class = "card",
               shiny::tags$div(class = "card-title", "TF Interaction Network",
                ...
                visNetwork::visNetworkOutput("network_plot", height = "700px")
              )
            )
          )
        ),
